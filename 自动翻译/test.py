...
if __name__ == "__main__":
    ...
    txts = read_and_write.read_file_by_line('in.txt', 1)
    for t in txts:
        result = list()
        contens = t.split(';')
        ...
        #
        #     # print(data[0])
        #     lk.loga(content, data[0])
        #     result.append(data[0])
        #     # print("count_time:{0}".format(end_time-start_time))
        # outf = open('out.txt', 'a', encoding='utf-8')
